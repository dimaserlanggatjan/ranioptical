...
Route::group(['middleware' =>['auth']], function(){
    ...
    Route::get('/province/{id}/cities', 'CartController@getCities')->name('city-destination');
    Route::post('/cek_ongkir', 'CartController@cek_ongkir')->name('cek_ongkir');
    Route::post('/pilih_ongkir', 'CartController@pilih_ongkir')->name('pilih_ongkir');
    Route::get('district/{id}','CartController@getDistrict')->name('district-destination');
